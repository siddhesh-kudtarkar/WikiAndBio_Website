...
$result = mysqli_query($conn, "SELECT first_name, last_name, image_link, redirect_link FROM activists");
?>
<!DOCTYPE html>
<html>

<head>
    <title>Activists - WikiAndBio</title>
...
<body class="w3-mobile fontConfig">
    ...
    <div class="w3-center w3-sidebar w3-bar-block w3-card w3-animate-left" style="width: 20%; display: none; top: 0px;" id="mySidebar">
    ...
    <div id="main">
        ...
        <div class="w3-container" style=" margin: 120px 0px 0px 10px;">
            ...
            <h1 class="fontConfig"><b>ACTIVISTS</b></h1>
        ...
        <div class="w3-container fontConfig" style="margin: 0px 10px 10px 10px;">
            ...
            <div class="w3-row w3-row-padding" style="margin-top: 20px; margin-bottom: 25px;">
                ...
                <div class="w3-col s4" style="margin-right: 10px; margin-left: -20px; margin-bottom: 20px;">
                        <a href="<?php echo $row["redirect_link"]; ?>" style="text-decoration: none;"><img class="centerImage w3-image" src="<?php echo $row["image_link"];?>" style="width: 290px; height: 300px; object-fit: contain;" alt="<?php 
