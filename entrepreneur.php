...
$result = mysqli_query($conn, "SELECT first_name, last_name, image_link, redirect_link FROM businessmen");
?>
<!DOCTYPE html>
<html>

<head>
    <title>Entrepreneurs - WikiAndBio</title>
...
<body class="w3-mobile fontConfig">
    ...
    <div class="w3-center w3-sidebar w3-bar-block w3-card w3-animate-left" style="width: 15%; display: none; top: 0px;" id="mySidebar">
        ...
        <a href="businessmen.php" class="w3-card-2 w3-bar-item w3-hover-blue w3-button">
        ...
        <div class="w3-right">
            ...
            <div class="w3-row w3-row-padding" style="margin-top: 20px; margin-bottom: 25px;">
                ...
                <div class="w3-col s4" style="margin-right: 10px; margin-left: -20px; margin-bottom: 20px;">
                        <a href="<?php echo $row["redirect_link"]; ?>" style="text-decoration: none;"><img class="centerImage w3-image" src="<?php echo $row["image_link"];?>" style="width: 300px; height: 320px; object-fit: contain;" alt="<?php 
