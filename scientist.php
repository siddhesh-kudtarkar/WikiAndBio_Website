...
$result = mysqli_query($conn, "SELECT first_name, last_name, image_link, redirect_link FROM scientists");
?>
<!DOCTYPE html>
<html>

<head>
    <title>Scientists - WikiAndBio</title>
...
<body class="w3-mobile fontConfig">
    ...
    <div id="main">
        ...
        <div class="w3-right">
            ...
            <h1 class="fontConfig"><b>SCIENTISTS</b></h1>
            ...
            <div class="w3-row w3-row-padding" style="margin-top: 20px; margin-bottom: 25px;">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ?>
                        <div class="w3-col s4" style="margin-right: 10px; margin-left: -20px; margin-bottom: 30px;">
                            <a href="<?php echo $row["redirect_link"]; ?>" style="text-decoration: none;"><img class="centerImage w3-image" src="<?php echo $row["image_link"]; ?>" style="width: 320px; height: 350px; object-fit: contain;" alt="<?php
        ...
        <div class="w3-dark-grey">
            ...
            <div class="w3-black">
                <div class="w3-row">
                    <p class="w3-left" style="padding: 10px; margin: 20px;"><i class="fa fa-copyright"></i> WikiAndBio<p class="w3-right" style="padding: 10px; margin: 20px;"><a href="http://www.wikiandbio.com/privacy-terms" style="text-decoration: none;">PRIVACY / TERMS</a></p>
                    </p>
                </div>
            </div>
        </div>
