...
$result = mysqli_query($conn, "SELECT first_name, last_name, image_link, redirect_link FROM politician");
?>
<!DOCTYPE html>
<html>

<head>
    <title>Politicians - WikiAndBio</title>
...
<body class="w3-mobile fontConfig">
    ...
    <div id="main">
        ...
        <div class="w3-right">
            ...
            <h1 class="fontConfig"><b>POLITICIANS</b></h1>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <div class="w3-col s4" style="margin-right: 10px; margin-left: -20px; margin-bottom: 20px;">
                            <a href="<?php echo $row["redirect_link"]; ?>" style="text-decoration: none;"><img class="centerImage w3-image" src="<?php echo $row["image_link"]; ?>" style="width: 320px; height: 340px; object-fit: contain;" alt="<?php
