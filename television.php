...
$result = mysqli_query($conn, "SELECT first_name, last_name, image_link, redirect_link FROM television");
?>
<!DOCTYPE html>
<html>

<head>
    <title>Television - WikiAndBio</title>
...
<body class="w3-mobile fontConfig">
    ...
    <div id="main">
        ...
        <div class="w3-container" style=" margin: 120px 0px 0px 10px;">
            ...
            <h1 class="fontConfig"><b>TELEVISION</b></h1>
        ...
        <div class="w3-container fontConfig" style="margin: 0px 10px 10px 10px;">
            ...
            <div class="w3-row w3-row-padding" style="margin-top: 20px; margin-bottom: 25px;">
                ...
                <div class="w3-col s4" style="margin-right: 10px; margin-left: -20px; margin-bottom: 20px;">
                        <a href="<?php echo $row["redirect_link"]; ?>" style="text-decoration: none;"><img class="centerImage w3-image" src="<?php echo $row["image_link"];?>" style="width: 350px; height: 280px; object-fit: contain;" alt="<?php 
