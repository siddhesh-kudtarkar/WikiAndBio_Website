...
$result = mysqli_query($conn, "SELECT first_name, last_name, image_link, redirect_link FROM bollywood");
?>
<!DOCTYPE html>
<html>

<head>
    <title>Bollywood - WikiAndBio</title>
...
<body class="w3-mobile fontConfig">
    ...
    <div id="main">
        ...
        <div class="w3-container" style=" margin: 120px 0px 0px 10px;">
            ...
            <h1 class="fontConfig"><b>BOLLYWOOD</b></h1>
